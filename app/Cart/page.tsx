...
<Image src="/rabadi.png" alt="" width={100} height={100}
/>
...
<div>
<h1 className='uppercase text-xl font-bold'>Rabari</h1>
<span>large</span>
</div>
...
<div className='flex justify-between '>
  <span className=''>Subtotal(3 items) </span>  <span className=''> &#8377; 510</span>
...
<hr className='my-2'/>
<div className='flex justify-between '>
  <span className=''> TOTAL(INCL. VAT) </span>  <span className='font-bold'> &#8377; 510</span>
